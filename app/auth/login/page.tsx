...
import { detectAuthProviders, type ProviderDetectionResult } from "@/lib/auth/provider-detection"
...
export default function LoginPage() {
  ...
  const [providerInfo, setProviderInfo] = useState<ProviderDetectionResult | null>(null)
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button
                ...
                className={showGoogleSuggestion ? "w-full animate-pulse" : "w-full bg-transparent"}
