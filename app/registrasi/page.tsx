...
export default function SecretPricingPage() {
      ...
      <main className="pt-24 overflow-x-hidden">
        <section className="py-20 px-4 bg-gradient-to-br from-primary/5 to-secondary/5 pt-20 pb-[30px]">
          <div className="max-w-6xl mx-auto">
            <h1 className="font-display text-4xl sm:text-5xl font-bold mb-6">On-Site Registration</h1>
            <p className="text-lg text-muted-foreground">
              Welcome to on-site registration for ISAPM 8th National Meeting 2026. Select from CPD
              courses, workshops, and symposium options below.
            </p>

            <div className="mt-6 p-6 bg-teal-50 border border-teal-200 rounded-lg text-teal-900">
              <h2 className="font-display text-2xl font-bold mb-3">On-Site Pricing</h2>
              <p className="text-lg">
                All prices shown are on-site registration rates. Add events to your cart and proceed to checkout.
              </p>
            </div>
